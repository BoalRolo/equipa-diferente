  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-lg mx-auto bg-white shadow-lg rounded-lg p-6 space-y-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Qual o nº da função?</h1>
        ...
        <Combobox value={selected} onChange={setSelected}>
          <div className="relative">
            ...
            />
            {filtered.length > 0 && (
              <Combobox.Options className="absolute z-10 mt-1 w-full bg-white shadow-lg max-h-60 overflow-auto rounded-md ring-1 ring-black ring-opacity-5">
                {filtered.map((fn) => (
                  <Combobox.Option
                    key={fn.code}
                    value={fn}
